...
import Swal from "sweetalert2";
import Booking from './Booking.js';
import omnicare from '../../images/OmniCareLogo.png';
import { useNavigate,useLocation } from "react-router-dom";
import ProviderPayment from "./ProviderPayment.js";
...
function AdminNav() {
    ...
    useEffect(() => {
        async function fetchData() {
          try {
            const response = await axios.get('http://localhost:3001/admin/getcard_data');
      ...
      const submitPayment = async()=>{
        try{
            var result = await axios.post(adminURl + '/submitpaymentdata');
      ...
      const logout =(async)=>{
        Cookie.set('Admin_Jwt_token','');
        navigate('/admin');        
      }
    return (
        <>
            <div className="d-flex flex-column flex-lg-row h-lg-full ">
                <nav className="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light  col-lg-3 border-bottom border-bottom-lg-0 border-end-lg position-fixed" id="navbarVertical"  style={{backgroundColor:'#ffb649'}}>
                    <div className="container-fluid">
                        <button className="navbar-toggler ms-n2" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarCollapse" aria-controls="sidebarCollapse" aria-expanded="false" aria-label="Toggle navigation">
                            <span className="navbar-toggler-icon"></span>
                        </button>
                        <Link className="cursor-pointer navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" to="/admin">
                            <img src={omnicare} width={170} height={170}/>
                        </Link>
                        <div className="collapse navbar-collapse" id="sidebarCollapse">
                            <ul className="navbar-nav ">
                                <li className="nav-item">
                                    <Link className="nav-link cursor-pointer text-dark"  onClick={()=>{setAdminComponent('homedata')}}>
                                        <i className="bi bi-house text-dark"></i> Dashboard
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('Services')}}>
                                        <i className="bi bi-bar-chart text-dark"></i> Services
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('Customer')}}>
                                        <i className="bi bi-bar-chart text-dark"></i> Customer
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('Providers')}}>
                                        <i className="bi bi-chat text-dark"></i> Providers
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('Booking')}}>
                                        <i className="bi bi-bookmarks text-dark"></i> Booking
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('cancelBooking')}}>
                                        <i className="bi bi-people text-dark"></i> Cancel Booking
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('UserReview')}}>
                                        <i className="bi bi-people text-dark"></i> User Review
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{setAdminComponent('paymentrequest')}}>
                                        <i className="bi bi-people text-dark"></i> Payment Request
                                    </Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="nav-link text-dark" onClick={()=>{logout()}}>
                ...
                <div className="h-screen flex-grow-1 overflow-y-lg-auto uper-head col-lg-9 " >
                    <header className=" border-bottom pt-6 " >
                        <div className="container-fluid bg-white" >
                            <div className="mb-npx">
                                <div className="row align-items-center">
                                    <div className="col-sm-6 col-12 mb-4 mb-sm-0">
                                        <h1 className="h2 px-2">Dashboard</h1>
                                    </div>
                                    <div className="col-sm-6 col-12 text-sm-end">
                                        <div className="mx-n1">                                            
                                            <Link to="#" className="btn d-inline-flex cursor-pointer btn-sm mx-1 text-dark" style={{ background: '#FFB649' }}>
                                                <span className=" pe-2">
                                                    <i className="bi bi-plus"></i>
                                                </span>
                                                <span onClick={handleShow}>
                    ...
                    <main className="py-6 ">
                        <div className="container-fluid" >                      
                            <div className="row g-6 mb-6">                                  
                                <div className="col-xl-3 col-sm-6 col-12 ">
                                    <div className="card shadow border-0 bg-warning " >
                                        <div className="card-body">                                               
                                            <div className="row">                                                   
                                                <div className="col ">
                                                    <span className="h6 font-semibold text-white text-sm d-block mb-2">Budget</span>
                                                    <span className="h3 font-bold mb-0 text-white">$750.90</span>
                                                </div>
                                                <div className="col-auto">
                                                    <div className="icon icon-shape bg-tertiary text-white text-lg rounded-circle">
                                                        <i className="bi bi-credit-card"></i>
                                ...
                                <div className="col-xl-3 col-sm-6 col-12">
                                    <div className="card shadow border-0 bg-success">
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col">
                                                    <span className="h6 font-semibold text-white text-sm d-block mb-2">Total Customer</span>
                                                    <span className="h3 font-bold mb-0 text-white">{CardData.result1}</span>
                                                </div>
                                                <div className="col-auto">
                                                    <div className="icon icon-shape bg-primary text-white text-lg rounded-circle">
                                                        <i className="bi bi-people"></i>
                                ...
                                <div className="col-xl-3 col-sm-6 col-12">
                                    <div className="card shadow border-0 bg-danger">
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col">
                                                    <span className="h6 font-semibold text-white text-sm d-block mb-2">Total Service Provider</span>
                                                    <span className="h3 font-bold mb-0 text-white">{CardData.result2}</span>
                                                </div>
                                                <div className="col-auto">
                                                    <div className="icon icon-shape bg-info text-white text-lg rounded-circle">
                                                        <i className="bi bi-clock-history"></i>
                                ...
                                <div className="col-xl-3 col-sm-6 col-12">
                                    <div className="card shadow border-0 bg-primary">
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col">
                                                    <span className="h6 font-semibold text-white text-sm d-block mb-2">Work load</span>
                                                    <span className="h3 font-bold mb-0 text-white">95%</span>
                                                </div>
                                                <div className="col-auto">
                                                    <div className="icon icon-shape bg-warning text-white text-lg rounded-circle">
                                                        <i className="bi bi-minecart-loaded"></i>
